      ...
      switch (type) {
        ...
        case 'template':
          dialog = {
            ...
            fullscreen: angular.isBoolean(this.wcDialogFullscreen) ? this.wcDialogFullscreen : true,
            clickOutsideToClose: angular.isBoolean(this.wcDialogModal) ? !this.wcDialogModal : false,
            escapeToClose: angular.isBoolean(this.wcDialogModal) ? !this.wcDialogModal : false
          };
          break;
        default:
